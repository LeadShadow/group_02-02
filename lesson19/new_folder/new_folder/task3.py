# Задана ведомость абитуриентов, сдавших вступительные экзамены в университет. Структура
# данных об абитуриентах представлена в виде следующего списка:
#
...
# быть записаны через запятую без пробелов фамилия абитуриента, код специальности, на которую
# он поступает, и полученные им баллы по отдельным дисциплинам.
#
