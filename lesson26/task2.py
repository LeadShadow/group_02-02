# В модуле 5 мы писали функцию sanitize_phone_number для нормализации строки с
# телефонным номером. Напомним, что при получении строк
#
...
def format_phone_number(func):
    def wrapper(*args, **kwargs):  # args -> 1, 2, 3, 4  # kwargs -> name='Sasha'
...
print(sanitize_phone_number('+093(731)-60-48'))