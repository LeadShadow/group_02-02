# Как известно, обычно разработчиков принято делить на три категории: Джун (Junior) — младший
# специалист, Мидл ( Middle) — основной разработчик в компании и Сеньйор (Senior) — старший
# разработчик. Ориентировочно можно считать, что до 1 года работы включительно — это Джуниор,
