...
# файла (последние символы в имени файла, как правило, после точки) и, в зависимости
# от расширения, принимать решение, к какой категории отнести этот файл.
#
...
# распакованное содержимое архива переносится в папку archives в подпапку, названную точно так же,
# как и архив, но без расширения в конце;
...
# filename -> C:\Users\pc\Desktop\заняття\group_02-02\hw5\мій_ткт_файл.txt
# filename.name -> miy_tkt_fail
...
if __name__ == "__main__":
    folder_for_scan = Path(input('Enter path to folder which you want clean: '))
